...
有几个列 = 359
多大的正方形 = 5
rectangle_scope = np.array([有多少行,(有多少行+多大的正方形),有几个列,(有几个列+30)]) # 分析旧视频
# 输入LED点亮的区域
LED点亮行 = 0
LED点亮列 = 0
...
# 进行分析
mf.pixel_record_2(input_path, rectangle_scope, LED_scope, video_form = 'mov', threshold_condition = 0.9, figure_condition_save = 'False', video_mode = 试验台是CED还是VR)# 新视频
