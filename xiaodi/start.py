...
# 进行分析
mf.pixel_record_2(input_path, r_s = rectangle_scope_token, grating_detect = grating_detect_token, LED_scope = LED_scope_token, video_form = 'mov', figure_condition_save = 'True', start_video = 'False', ana_frame_num = 'All', video_mode = 'NaN')# 新视频
print ('\a'*7) # 程序完结后发出声音
